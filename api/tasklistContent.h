...
// This is a structure that uses as either input/output for tasklistWorker
// object's properties/fields For create: it contains field values of the
// created tasklist as input For Query: it will contain field values of the
// queried tasklist as output For Revise: it contains field values of the
// revised tasklist as input
